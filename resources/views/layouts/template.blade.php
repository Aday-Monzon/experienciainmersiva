...
<html>
	<head>
		<title>Experiencias Inmersivas</title>
		<meta charset="utf-8" />
								...
								<div class="content color0 span-3-75">
                                    <div class="login">
                                     @if (Route::has('login'))
                                            ...
                                            @else
                                                <a href="{{ route('login') }}" class="css-button-3d--yellow">Identifícate</a>

                                                @if (Route::has('register'))
                                                    <a href="{{ route('register') }}" class="css-button-3d--yellow">Regístrate</a>
                                                @endif
                                            @endauth
