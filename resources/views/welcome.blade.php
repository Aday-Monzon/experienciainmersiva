...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <script>
        ...
        scene.background =  new THREE.TextureLoader().load( "images/fondoazul.png" );
        var geometry = new THREE.BoxGeometry(20,20,20);
        const loader = new THREE.TextureLoader();

        const material = new THREE.MeshBasicMaterial({
            map: loader.load('images/fondo.jpg'),
        });
        //var material = new THREE.MeshLambertMaterial( { color: 0xfd90d7 } );
